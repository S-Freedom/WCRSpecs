Pod::Spec.new do |s| 
  ...
  s.platform = :ios, "8.0" 
  s.source = {:http => "http://cloudclass-static.oss-cn-beijing.aliyuncs.com/static/zby-sdk/zby-ios-sdk/WCRLiveUI/2.0.85-xiwang/frameworks.zip" } 
